package com.example.aplikasitokoonline.view.main
...
import com.example.aplikasitokoonline.view.history.RiwayatActivity
import com.example.aplikasitokoonline.view.input.InputDataActivity
import com.example.aplikasitokoonline.view.jenis.infoAplikasi
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        ...
        cvKategori.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, InfoAplkiasiActivity::class.java)
            startActivity(intent)
        }
